          ...
          <div class="navbar-collapse-header d-md-none">
            <div class="row">
              <div class="col-6 collapse-brand">
                <a href="../index.html">
                  <img src="/assetss/assets/img/brand/blue.png">
                </a>
              </div>
          ...
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              <a class="nav-link nav-link-icon" href="/">
                ...
                <span class="nav-link-inner--text">Go to site</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link nav-link-icon" href="#!">
                <i class="ni ni-planet"></i>
                <span class="nav-link-inner--text">Go to home</span>
              </a>
            </li>
            <!-- <li class="nav-item">
        ...
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-lg-5 col-md-6">
              ...
              <p class="text-lead text-light">Silahkan Masuk terlebih dahulu untuk mengakses control admin.</p>
            </div>
          </div>
        </div>
      </div>
              ...
              <form role="form" method="post" action="admin-dashboard">
                ...
                <div class="form-group">
                  <div class="input-group input-group-alternative">
                    ...
                    <input class="form-control" placeholder="Password" type="password" name="email">
